            ...
            `public class Main
{
    ...
    // ---------------text---------------
        ...
        $('#htmlEditor,#htmlTextarea,#htmlTextarea1,#lineCounter1,#lineCounter,#IO,#source.futureWork,.encrypt,.kali').fadeOut(900)
        ...
        document.getElementById('source').innerHTML = `Your code here`;
    }
    // --------------Encrypt-----------------
...
button1.addEventListener('click', function () {
    ...
    // document.getElementById("receverData").innerHTML += "Encoded : " + encoded + "<br>" + "Decoded : " + decoded+"<br>";
